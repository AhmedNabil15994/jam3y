...
@section('title',__('dashboard.pages.edit.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('dashboard.pages.edit.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" role="form" class="form-horizontal form-row-seperated" method="post" action="{{route('pages.update',$page->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9" style="margin-top:-15px">
                        <div class="tab-content">
                            @include('dashboard.pages.forms.edit')
                        </div>
                    </div>
                    <div class="col-md-12">
