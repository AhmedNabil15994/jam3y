...
@section('title',__('dashboard.courses.create.title'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('dashboard.courses.create.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" action="{{route('courses.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            @include('dashboard.courses.forms.create')
                        </div>
                    </div>
                    <div class="col-md-12">
