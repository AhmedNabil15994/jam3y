    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('dashboard.roles.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    {{-- DATATABLE FILTER --}}
                    @include('dashboard.roles.forms.filter')
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('dashboard.roles.datatable.title')}}</th>
                                    <th>{{__('dashboard.roles.datatable.name')}}</th>
                                    <th>{{__('dashboard.roles.datatable.permissions')}}</th>
                                    <th>{{__('dashboard.roles.datatable.created_at')}}</th>
                                    <th>{{__('dashboard.roles.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
@section('scripts')
  ...
  @include('dashboard.roles.forms.table')
