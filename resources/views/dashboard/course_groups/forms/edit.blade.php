<div class="tab-pane fade active in" id="global_setting">
    ...
    <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" name="title[{{$code}}]" class="form-control" data-name="title.{{$code}}" value="{{optional($group->translate($code))->title}}">
            ...
            <div class="col-md-12">
                ...
                @foreach ($group->links as $link)
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9">
                          <input type="text" name="title_link_{{$code}}[]" class="form-control" data-name="title_link_{{$code}}" value="{{optional($link->translate($code))->title}}">
                          <div class="help-block"></div>
                      </div>
                  </div>
                  @endforeach
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9">
                          <input type="checkbox" class="ischecked" name="is_free[]" value="1" onclick="checkFunction()" {{($link->is_free == 1) ? 'checked' : ''}}>
                          <input type="hidden" class="isUnchecked" name="is_free[]" value="0" {{($link->is_free == 1) ? 'disabled' : ''}}>
                      </div>
                  </div>
                  <div class="form-group">
