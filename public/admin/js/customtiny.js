var editor_LTR = {
	...
	file_browser_callback : function(field_name, url, type, win) {
		...
		var cmsURL = editor_LTR.path_absolute + 'laravel-filemanager?field_name=' + field_name;
		if (type == 'image') {
...
var editor_RTL = {
	...
	file_browser_callback : function(field_name, url, type, win) {
		...
		var cmsURL = editor_RTL.path_absolute + 'laravel-filemanager?field_name=' + field_name;
		if (type == 'image') {
			cmsURL = cmsURL + "&type=Images";
		} else {
			cmsURL = cmsURL + "&type=Files";
